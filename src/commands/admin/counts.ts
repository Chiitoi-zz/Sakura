...
export default class CountsCommand extends Command {
    ...
    public async exec(message: Message) {
        const { guild }  = message
        const { categoryIds, ignoreIds } = this.client.portals.get(guild) as SakuraGuild
        ...
        const embed: Partial<MessageEmbed> = {
            ...
            footer: { text: 'Ignored channels are not included in the channel count. The channel count is the number of channels Sakura will check.' },
